import { getUserAction, isPasswordVerifiedAction } from "@/api/auth/auth-action"
...
export const useIsPasswordVerified = () => {
  const { data } = useQuery({
    queryKey: ["is-password-verified"],
    queryFn: isPasswordVerifiedAction,
    retry: 1,
  })
  return { data }
}
