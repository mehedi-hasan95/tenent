...
import { adminCountryBasedReportAction } from "@/api/reports/admin/admin-report-action"
...
export const AdminReactMap = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["admin-country-order"],
    queryFn: adminCountryBasedReportAction,
  })
