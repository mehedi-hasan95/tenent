...
import { adminSingleOrderAction } from "@/api/reports/admin/admin-report-action"
...
const Page = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["admin-single-order", params.id],
    queryFn: () => adminSingleOrderAction({ id: params.id }),
  })
